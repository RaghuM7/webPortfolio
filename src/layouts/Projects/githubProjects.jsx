      ...
      <Wrapper as={Container} id="projects">
        ...
        <Grid>
          {Object.keys(githubUserData).length !== 0 ? (
                    ...
                    <div className="repo-left">
                      <div className="repo-lang">
                        <span
                          ...
                          style={{
                            backgroundColor: item.node.primaryLanguage?.color || "#ccc",
                          }}
                        ></span>
                        <span>{item.node.primaryLanguage?.name || "Unknown"}</span>
                      </div>
                      <div>
            ...
            <div>Loading projects or no projects found...</div>
          )}
        </Grid>
        <div className="seeMoreProjects">
          <a
            href="https://github.com/RaghuM7?tab=repositories"
            target="_blank"
            rel="noopener noreferrer"
          >
